    ...
    <footer class="footer">
      <div class="container">
        <div class="grid grid-4">
          ...
          <div>
            <h5>Contact</h5>
            <a href="tel:+254711770015">+254711770015</a>
...
function renderWhatsApp(message = 'equipment hire') {
  ...
  return `
    <a href="https://wa.me/+254711770015?text=${text}" class="whatsapp-float" target="_blank" rel="noopener" aria-label="Chat on WhatsApp">
      ${WHATSAPP_SVG}
    </a>`;
}
